...
func main() {
	...
	e.GET("/v1/me/given-feedbacks", feedbackHandler.ListMyGivenFeedbacks, handler.Auth(tokenSigner))
	e.POST("/v1/feedback-drafts", feedbackHandler.CreateFeedbackDraft, handler.Auth(tokenSigner))
	e.GET("/v1/feedback-drafts", feedbackHandler.ListMyFeedbackDrafts, handler.Auth(tokenSigner))
	e.GET("/v1/feedback-drafts/:id", feedbackHandler.GetFeedbackDraft, handler.Auth(tokenSigner))
